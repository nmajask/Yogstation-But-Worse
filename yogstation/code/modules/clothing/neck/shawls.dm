...
/obj/item/clothing/neck/yogs/shawl/cap
	...
	alticon_state = "capshawlalt" //Uses a darker colors that looks better in my opinin
...
/obj/item/clothing/neck/yogs/shawl/hop
	...
	item_state = "hopshawl"
	resistance_flags = FIRE_PROOF
	alticon_state = "hopshawlalt" //Uses a darker colors that looks better in my opinin
...
/obj/item/clothing/neck/yogs/shawl/hos
	...
	item_state = "hosshawl"
	resistance_flags = FIRE_PROOF
	alticon_state = "hosshawlalt" //Uses a design that uses the old colors as it might help it stand out
...
/obj/item/clothing/neck/yogs/shawl/rd
	...
	item_state = "rdshawl"
	resistance_flags = FIRE_PROOF
	alticon_state = "rdshawlalt" //Just a version without any of the purple, as i couldn't think of anything better
