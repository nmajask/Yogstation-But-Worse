...
/obj/item/clothing/head/yogs/truecowboy2
	name = "cowboy hat"
	desc = "Perfect for rounding up some cattle."
	icon_state = "cowboy2"
	item_state = "cowboy2"
...
/obj/item/clothing/head/yogs/whitecaptaincap
	name = "white captain cap"
...
/obj/item/clothing/head/yogs/trainman
	name = "trainman cap"
	desc = "ALLL ABOARDDDDDDD!!!"
	icon_state = "trainman"
	item_state = "trainman"
...
/obj/item/clothing/head/yogs/billydonkahat
	name = "billy donka hat"
