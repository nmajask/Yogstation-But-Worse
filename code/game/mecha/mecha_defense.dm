...
/obj/mecha/bullet_act(obj/item/projectile/Proj) //wrapper
	if ((!enclosed || istype(Proj, /obj/item/projectile/bullet/shotgun/slug/uranium) || istype(Proj, /obj/item/projectile/bullet/railgun)) && occupant && !silicon_pilot && !Proj.force_hit && (Proj.def_zone == BODY_ZONE_HEAD || Proj.def_zone == BODY_ZONE_CHEST)) //allows bullets to hit the pilot of open-canopy mechs
