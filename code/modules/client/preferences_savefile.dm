...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["device_color"], device_color)
	READ_FILE(S["device_interface"], device_interface)
	READ_FILE(S["device_stripe"], device_stripe)
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["device_color"], device_color)
	WRITE_FILE(S["device_interface"], device_interface)
	WRITE_FILE(S["device_stripe"], device_stripe)
