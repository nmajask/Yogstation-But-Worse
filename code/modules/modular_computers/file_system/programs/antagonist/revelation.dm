...
/datum/computer_file/program/revelation/proc/activate()
	if(computer)
		if(istype(computer, /obj/item/modular_computer/integrated)) //If this is a borg's integrated tablet
			var/obj/item/modular_computer/integrated/modularInterface = computer
		...
		var/obj/item/stock_parts/cell/cell = computer.all_components[MC_CELL]
		var/obj/item/computer_hardware/recharger/recharger = computer.all_components[MC_CHARGE]
		qdel(hard_drive)
		computer.take_damage(25, BRUTE, 0, 0)
		if(cell && prob(25))
			qdel(cell)
			computer.visible_message(span_notice("\The [computer]'s [cell] explodes in a rain of sparks."))
