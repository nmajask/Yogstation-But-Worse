...
/datum/computer_file/program/security_record
	filename = "secrecord"
	filedesc = "Security Record Viewer"
	file_icon = "address-book"
	category = PROGRAM_CATEGORY_MISC
	program_icon_state = "comm_monitor"
	extended_desc = "This program allows for viewing, editing, and saving standard file formats"
	size = 5
	available_on_ntnet = TRUE
	tgui_id = "address-book"
	...
	var/special_message
/*
/datum/computer_file/program/security_record/ui_data(mob/user)
...
/datum/computer_file/program/security_record/ui_data(mob/living/carbon/human/user)
	var/list/data = list()
	data["records"] = list()

	data["z"] = computer.physicial.z
...
/datum/computer_file/program/security_record/ui_act(action, params)
	if(..())
		return
