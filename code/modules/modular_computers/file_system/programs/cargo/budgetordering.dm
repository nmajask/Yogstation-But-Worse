/datum/computer_file/program/budgetorders
	...
	requires_ntnet = TRUE
	usage_flags = PROGRAM_LAPTOP | PROGRAM_TABLET | PROGRAM_PHONE | PROGRAM_TELESCREEN | PROGRAM_INTEGRATED
	size = 20 
	tgui_id = "NtosCargo"
	program_icon = "shopping-cart"
	...
	var/static/safety_warning = "For safety reasons, the automated supply shuttle \
		cannot transport live organisms, human remains, classified nuclear weaponry, \
		homing beacons or machinery housing any form of artificial intelligence."
	///If you're being raided by pirates, what do you tell the crew?
	var/static/blockade_warning = "Bluespace instability detected. Shuttle movement impossible."
