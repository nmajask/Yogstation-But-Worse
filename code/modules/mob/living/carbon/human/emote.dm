...
/datum/emote/living/carbon/human/scream/get_sound(mob/living/user)
	...
	if(H.mind?.miming)
		return
	if(iscatperson(H)) //Yogs Start: Felinid Scream
		return pick('yogstation/sound/voice/feline/scream1.ogg', 'yogstation/sound/voice/feline/scream2.ogg')
	else if(ishumanbasic(H)) //Yogs End
...
/datum/emote/living/carbon/meow //Yogs Start: Felinid Meow
	key = "meow"
...
/datum/emote/living/carbon/meow/get_sound(mob/living/user)
	return pick('yogstation/sound/voice/feline/meow1.ogg', 'yogstation/sound/voice/feline/meow2.ogg') //Yogs End
