...
/datum/techweb_node/biotech
	...
	design_ids = list("chem_heater", "chem_master", "chem_dispenser", "sleeper", "pandemic", "defibrillator", "defibmount", "operating", "soda_dispenser", "beer_dispenser", "healthanalyzer", "medspray", "genescanner", "rollerbed")
...
/datum/techweb_node/adv_biotech
	...
	design_ids = list("piercesyringe", "pinpointer_crew", "smoke_machine", "plasmarefiller", "limbgrower", "meta_beaker", "healthanalyzer_advanced", "harvester", "holobarrier_med", "detective_scanner", "detective_scanner_advanced" , "defibrillator_compact")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
...
/datum/techweb_node/engineering
	...
	"apc_control", "cell_charger", "power control", "airlock_board", "firelock_board", "airalarm_electronics", "firealarm_electronics", "stack_console", "stack_machine",
	"oxygen_tank", "plasma_tank", "emergency_oxygen", "emergency_oxygen_engi", "plasmaman_tank_belt", "electrolyzer", "floorigniter", "crystallizer")
...
/datum/techweb_node/high_efficiency
	...
	design_ids = list("pico_mani", "super_matter_bin", "pcpu_normal", "pcpu_small")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 7500)
	export_price = 5000
...
/datum/techweb_node/comptech
	...
	design_ids = list("cargo", "cargorequest", "libraryconsole", "mining", "crewconsole", "rdcamera", "comconsole", "idcardconsole", "seccamera", "pda", "laptop", "netcard_basic", "netcard_wired", "hdd_basic", "hdd_advanced", "ssd_micro", "portadrive_basic", "portadrive_advanced")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
	export_price = 5000

/datum/techweb_node/microcomputing
	id = "computer_hardware_basic"
	display_name = "Micro-Computing"
	description = "How to make computer very small."
	prereq_ids = list("comp_recordkeeping")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
	export_price = 3000
	design_ids = list("tablet", "phone", "ssd_micro", "miniprinter")
...
/datum/techweb_node/comp_recordkeeping
	...
	prereq_ids = list("comptech")
	design_ids = list("secdata", "med_data", "prisonmanage", "vendor", "automated_announcement", "hdd_super", "hdd_cluster", "portadrive_super", "printer")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1000)
	export_price = 2000
...
/datum/techweb_node/telecomms
	...
	"s-ansible", "s-filter", "s-amplifier", "ntnet_relay", "s-treatment", "s-analyzer", "s-crystal", "s-transmitter", "s-traffic", "s-messaging", "netcard_advanced")
